...
# White 墨蓋 glyph must be centered by its actual FreeType ink bbox rather than
# by the font em square / baseline approximation.
...
print("OK: 墨蓋 parser, inset box, and metric-centered glyph checks passed")
